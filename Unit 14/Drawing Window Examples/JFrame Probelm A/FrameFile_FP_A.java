...
public class FrameFile_FP_A extends JFrame
{
	public FrameFile_FP_A(String frameName, int frameWidth, int frameHeight)
	{
		...
		// turns off the frames title bar and border
		setUndecorated(true);

...
class Searches {
    ...
    /**
     * Pre: receives an array of data and a value to find
     * post: returns the index where the value was found in the array or -1 if the value was not found
     *
     * @param data      the array of data to check
     * @param numToFind the number to find
     */
    private static int linearSearch(int[] data, int numToFind) {
     ...
     * @param data      the array of data to check
     */
    private static int binarySearch(int[] data, int numToFind) {
        int start = 0;
        int end = data.length;
        while (start <= end) {
